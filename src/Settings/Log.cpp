...
/*   Updated: 2024/07/27 21:16:12 by vzurera-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Log::log_access(const std::string & str, const VServer * VServ) {
	if (VServ && VServ->get("access_log") != "") log(str, VServ->get("access_log"));
	else log(str, Settings::get("access_log"));
}

void Log::log_error(const std::string & str, const VServer * VServ) {
	if (VServ && VServ->get("error_log") != "") log(str, VServ->get("error_log"));
